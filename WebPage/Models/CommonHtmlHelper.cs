...
namespace WebPages
{
    public class CommonHtmlHelper
    {
        ...
        /// <param name="PageNum">显示多少个页码</param>
        ...
        public static MvcHtmlString PaginationPager(int Page, int PageSize, int Count, int PageNum, string Url)
        {
            ...
            {
                //记录分页栏首个页码 index
                str.Append("<li class=\"paginate_button previous\" id=\"example_first\">");
                str.Append("<a href=\"" + ((Url.IndexOf("@p@") >= 0) ? Url.Replace("@p@", "1") : (Url + "page=1")) + "\" aria-controls=\"example\" data-dt-idx=\"1\" tabindex=\"0\">首页</a></li>");
            }
            else
            {
                str.Append("<li class=\"paginate_button previous disabled\" id=\"example_first\"><a href=\"\" aria-controls=\"example\" data-dt-idx=\"1\" tabindex=\"0\">首页</a></li></li>");//第一个分页栏中首页不可点击
            }
            //处理上一页页码
            if (Page > 1)
            {
            ...
            {
                str.Append("<li class=\"dot\"><span>......</span></li>");
                str.Append("<li class=\"paginate_button\">");
                str.Append("<a  href=\"" + ((Url.IndexOf("@p@") >= 0) ? Url.Replace("@p@", num.ToString()) : (Url + "page=" + num.ToString())) + "\" >" + num + "</a></li>");
            ...
            if (Page < num)
            {
                str.Append("<li class=\"paginate_button next\" id=\"example_last\">");
            ...
            {
                str.Append("<li class=\"paginate_button next disabled\" id=\"example_last\"><a href=\"\" aria-controls=\"example\" data-dt-idx=\"1\" tabindex=\"0\">末页</a></li></li>");
            }
        ...
        public static MvcHtmlString PaginationUlPager(int Page, int PageSize, int Count, int PageNum, string Url)
        {
            ...
            str.Append("<div class=\"btn-group pull-right\">");
            //处理上一页页码
            if (Page > 1)
            {
                index = Page - 1;
                str.Append("<a class=\"btn btn-white btn-sm\" href=\"" + ((Url.IndexOf("@p@") >= 0) ? Url.Replace("@p@", index.ToString()) : (Url + "page=" + index.ToString())) + "\" title=\"上一页\" ><i class=\"fa fa-angle-left\"></i></a>");
            }
            else
            {
                str.Append("<a class=\"btn btn-white btn-sm\" href=\"javascript:void(0)\"  disabled=\"disabled\" title=\"上一页\" ><i class=\"fa fa-angle-left\"></i></a>");
            }
            //下一页
            if (Page < num)
            {
                index = Page + 1;
                str.Append("<a class=\"btn btn-white btn-sm\" href=\"" + ((Url.IndexOf("@p@") >= 0) ? Url.Replace("@p@", index.ToString()) : (Url + "page=" + index.ToString())) + "\" title=\"下一页\" > <i class=\"fa fa-angle-right\"></i></a>");
            }
            else
            {
                str.Append("<a class=\"btn btn-white btn-sm\" href=\"javascript:void(0)\" disabled=\"disabled\" title=\"下一页\" > <i class=\"fa fa-angle-right\"></i></a>");
            }
